...
source_directory1 = 'g:/work/2023/file_download/new-pb4g-20231205'
glob_pattern = '*download.txt'
output_directory = 'g:/work/2023/file_download/new-pb4g-20231205'
...
genreport.set_duckdb_output_name(duckdb_output_name='new-pb4g-20231205.duckdb')
genreport.set_output_report_name(xlsx_name='new-pb4g-20231205-summary.xlsx')
