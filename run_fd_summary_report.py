...
source_directory    = 'g:/work/2024/magflows/batch1'
duckdb_output_path  = source_directory + '/magflows_data.duckdb'
xlsx_output_path    = source_directory + '/magflows-summary-report.xlsx'
