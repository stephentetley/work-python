...
gensqlite.add_xlsx_source(XlsxSource('g:/work/2023/point_blue/s4_point_blue_export_with_east_north-20231019.XLSX', 'Sheet1'), table_name='s4_point_blue', df_trafo=None)
gensqlite.add_xlsx_source(XlsxSource('g:/work/2023/point_blue/OP-updates-combined.xlsx', 'Sheet1'), table_name='aib_worklist', df_trafo=remove_requested_by)
...
retire_csv_outpath='g:/work/2023/point_blue/pointblue_retire_report_op.csv'
...
new4g_csv_outpath='g:/work/2023/point_blue/pointblue_new4g_report_op.csv'
