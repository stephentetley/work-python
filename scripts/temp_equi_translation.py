...
import sptapps.equi_asset_translation.equi_translation as equi_translation
...
equi_translation.setup_equi_translation(con=con, 
...
equi_translation.import_ai2_exports_to_ai2_landing(con=con, 
                                                         source_folder=source_folder,
                                                         glob_pattern='mal12-ai2*.xlsx')

equi_translation.translate_ai2_eav_to_ai2_classrep(con=con)
